                ...
                item {
                    SettingsSection(
                        ...
                        Text(
                            text =
                                Localization
                                    .tr(LocalContext.current, "health.bmr.example", "BMR: ~%@ %@")
                                    .replace("%@", "1,650")
                                    .replaceFirst(
                                        "%@",
                                        Localization
                                            .tr(
                                                ...
                                                "%@/day",
                                            ).replace("%@", Localization.tr(LocalContext.current, "units.kcal", "kcal")),
                                    ),
                            color = Color.White,
                            style = MaterialTheme.typography.bodyLarge,
                        )
                            ...
                            Text(
                                text =
                                    Localization.tr(
                                        ...
                                        "Important: These are general guidelines. Consult with a healthcare provider for personalized dietary advice, especially if you have medical conditions or specific health goals.",
                                    ),
                                color = Color.White,
                                style = MaterialTheme.typography.bodySmall,
                            )
        ...
        if (showSaveDialog) {
            AlertHelper.SimpleAlert(
                ...
                message =
                    Localization.tr(
                        LocalContext.current,
                        "health.settings.saved.msg",
                        "Your health settings have been saved successfully.",
                    ),
                isVisible = true,
                onDismiss = {
